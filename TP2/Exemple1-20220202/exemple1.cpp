...
int main(int argc, char**argv) {
    ...
    //MPI_Win_create(&a, sizeof(int), sizeof(int),MPI_INFO_NULL, MPI_COMM_WORLD,&TheWin); //POUR LE GET
    MPI_Win_create(tab, nprocs * sizeof(int), sizeof(int),MPI_INFO_NULL, MPI_COMM_WORLD,&TheWin); //POUR LE PUT
